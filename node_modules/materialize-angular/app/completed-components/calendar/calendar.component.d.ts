...
export declare class CalendarComponent implements OnInit, OnChanges {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<CalendarComponent, "materialize-calendar }", never, { "className": "className"; "date": "date"; "displayOtherMonthDays": "displayOtherMonthDays"; }, { "onSelectDayEmitter": "onSelectDay"; }, never, never>;
}
