...
export declare class SelectComponent implements ControlValueAccessor, AfterContentInit, SelectModel {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<SelectComponent, "materialize-select }", never, { "className": "className"; "disabled": "disabled"; "floatLabel": "floatLabel"; "id": "id"; "isNativeControl": "isNativeControl"; "name": "name"; "required": "required"; "value": "value"; }, { "onChangeEmitter": "onChange"; }, ["options"], ["materialize-select-option"]>;
}
