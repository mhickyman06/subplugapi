...
export declare class DatePickerComponent implements ControlValueAccessor, OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<DatePickerComponent, "materialize-datepicker }", never, { "className": "className"; "disabled": "disabled"; "displayOtherMonthDays": "displayOtherMonthDays"; "floatLabel": "floatLabel"; "format": "format"; "fullSize": "fullSize"; "id": "id"; "name": "name"; "placeholder": "placeholder"; "required": "required"; "inputValue": "inputValue"; }, {}, never, never>;
}
