...
export declare class SliderComponent implements AfterContentInit, AfterViewInit, ControlValueAccessor, SliderModel {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<SliderComponent, "materialize-slider }", never, { "className": "className"; "disabled": "disabled"; "required": "required"; "showLabels": "showLabels"; "showTicks": "showTicks"; "value": "value"; }, { "onChangeEmitter": "onChange"; }, ["options"], ["materialize-slider-indicator", "materialize-slider-option"]>;
}
